...
vi.mock("@beutl/db", () => ({
  ...
  deleteSubscriptionCheckoutAttemptBySessionId: mocks.deleteAttempt,
  deletePackageCheckoutAttemptBySessionId: mocks.deleteAttempt,
  claimDetachedPackageCheckoutAttempt: mocks.claimDetached,
  claimDetachedSubscriptionCheckoutAttempts: mocks.claimDetachedPro,
  completeDetachedSubscriptionCheckoutRecovery: mocks.completeDetachedPro,
