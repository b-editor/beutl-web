...
export function Form({ email, cancelable, lang, ...props }: ComponentProps<"form"> & { email: string, cancelable?: boolean, lang: string }) {
  ...
  return (
    <form {...props} action={dispatch}>
      <div className="flex flex-col gap-4">
        ...
        <p>
          {t('account:email.clickOnTheLink')}<br />
        ...
        <div className="flex gap-4 my-6">
          <SubmitButton variant="destructive" showSpinner={spinnerType === 0} onClick={() => setSpinnerType(0)}>{t('account:data.deleteAccount')}</SubmitButton>
