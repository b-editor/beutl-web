  ...
  return (
    <div className="flex flex-col space-y-1.5 max-w-xs">
      ...
      <div className="flex gap-2">
        <Input type="text" id="userName" name="userName" defaultValue={profile?.userName} readOnly={locked} />
      ...
      {state.errors?.userName && <ErrorDisplay errors={state.errors.userName} />}
    </div>
  )
}
    ...
    <form {...props} action={dispatch}>
      <div className="flex flex-col gap-4">
        <div className="flex flex-col space-y-1.5 max-w-xs">
          ...
          <Input type="text" id="displayName" name="displayName" defaultValue={profile?.displayName} maxLength={50} />
          <p className="text-sm text-muted-foreground">50文字以下</p>
        ...
        <div className="flex flex-col space-y-1.5 max-w-md">
          ...
          <Textarea id="bio" name="bio" defaultValue={profile?.bio || undefined} maxLength={150} />
          <p className="text-sm text-muted-foreground">拡張機能を公開したとき、このプロフィールが表示されます。150文字以下</p>
          {state.errors?.bio && <ErrorDisplay errors={state.errors.bio} />}
        </div>
